...
export default {
  ...
  methods: {
    refreshTable() {
      this.apiGet(this.ROUTES.payrollJournal, "Get Payroll Journal Error").then((res) => {
        const { data } = res;
    ...
    submitNew() {
      ...
      if (this.$v.$invalid) {
        ...
        this.apiPost(this.ROUTES.payrollJournal, data, "Add Journal Code Error").then((res) => {
    ...
    submitUpdate() {
      ...
      if (this.$v.$invalid) {
        ...
        this.apiPatch(this.ROUTES.payrollJournal, data, "Update Code Error").then(
            (res) => {
